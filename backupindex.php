...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target="#main-navbar">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="#saran">Kritik Saran</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
            </nav>
        ...
        <!--Home page style-->
        <header id="beranda" class="sections beranda">
            <div class="container">
                <div class="row">
                    <div class="homepage-style">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="unique-apps">
                                <h3 class="animated infinite bounce">Embun Pagi</h3>
                                <p align="justify";>Sebuah nama yang memfilosofikan kesejukan bagi hati yang merindukan ketenangan.
                                  Seperti embun yang tidak pernah memilih di daun mana butiran butirannya akan terbentuk,
                                  bentuknya yang sederhana dan memberikan kesejukan.
                                </p>
                                <p align="justify";>
                                  Kehadirannya bukan hanya untuk menjangkau pepohonan yang tinggi saja
                                  melainkan ia mampu menghadirkan dirinya hingga kererumputan,
                                  membasahi seluas-luasnya bumi dengan adil dan merata.
                                </p>
                                <div class="home-btn"><button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Gabung</button></div>
                            </div>
                        </div>
                    ...
                    <div class="main-history">
                        <div class="col-md-4">
                            <div class="history-img">
                                <img src="assets/images/logo-embun.png" style="width: 350px;height: 350px;text-align: center;" class="img-responsive" alt="Responsive image"/>
                            </div>
                        </div>
                        <div class="col-md-8">
                            ...
                            <div class="history-wrapper">
                                <div class="history-heading">
                                  <h5 class="our-history">Visi dan Misi</h5>
                                </div>
                                <div class="history-content">
                                    <p>
                                      <strong>Visi :</strong><br />
                                        Menjadi komunitas yang berperan dalam mencerdaskan masyarakat.
                                    </p>
                                    <p>
                                      <strong>Misi :</strong><br />
                                      1. Berperan dalam membantu pemenuhan pendidikan bagi masyarakat yang membutuhkan. <br />
                                      2. Sebagai Fasilitator Pendidikan bagi masyarakat.
                                    </p>
                                    </p>
                                </div>
                        </div>
        ...
        <section id="struktur" class="sections">
            <div class="container text-center">
                <div class="heading">
                    <div class="title text-center arrow-left">
                        <img class="hidden-xs" src="assets/images/left-arrow.png" alt="" />
                        <h4 class="">Struktur Embun Pagi</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="main-works">
                            <img src="assets/images/struktur3.png" class="img-responsive img-thumbnail" alt="img-responsive" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="galeri" class="sections">
            <div class="container">
                    ...
                    <div class="row">
                      <?php 
                      include 'system/koneksi.php';
                      $sql = "SELECT * FROM tb_post_galeri";
                      $result = mysqli_query($connect,$sql);
                      while ($data = mysqli_fetch_array($result))
                      {?>
                        <div class="img-thumbnail" style="width: 385px; height: 385px;">
                          <a class="fancybox" href="assets/images/galeri/<?php echo $data['path'] ?>" data-fancybox-group="gallery">
                            <img src="assets/images/galeri/<?php echo $data['path'] ?>">
                          </a>
                        </div>
                      <?php }
                      ?>
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="team-member">
                                ...
                                <h5>Harun</h5>
                                <p>"Penanggung Jawab Desain Kreatif"</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="team-member">
