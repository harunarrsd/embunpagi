      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="report_berita.php"><i class="fa fa-circle-o"></i>Berita</a></li>
          ...
          while ($data = mysqli_fetch_array($result))
            {?>
              <tr>
                ...
                <td><a href="form_edit_berita.php?id=<?php echo $data['id'] ?>" class="btn-xs btn-primary">Edit</a><a onclick="return confirm('Apakah Anda yakin ?')" href="delete_berita.php?id=<?php echo $data['id'] ?>" class="btn-xs btn-danger">Delete</a></td>
              </tr>
              <?php $no++;}?>
            </tbody>
          </table>
