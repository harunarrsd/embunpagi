...
$id = $_GET['id'];
$sql = "SELECT * FROM tb_post_artikel WHERE id = $id";
          ...
          <form action="edit_galeri.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="judul" class="form-control" value="<?php echo $judul ?>" placeholder="Komunitas Embun Pagi" required>
              </div>
              <div class="form-group">
                <label>Deskripsi Artikel</label>
                <textarea class="form-control" name="isi" rows="8" placeholder="Kegiatan Embun Pagi..." required><?php echo $isi ?></textarea>
              </div>
