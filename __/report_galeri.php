      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="report_galeri.php"><i class="fa fa-circle-o"></i>Artikel</a></li>
          </ul>
        </li>
        <li>
          <a href="logout.php">
    ...
    <section class="content">
      ...
      <table class="table table-hover" id="myTable">
        ...
        <tbody>
          ...
          $sql = "SELECT * FROM tb_post_artikel";
          ...
          while ($data = mysqli_fetch_array($result))
            {?>
              <tr>
                ...
                <td><a href="form_edit_galeri.php?id=<?php echo $data['id'] ?>" class="btn-xs btn-primary">Edit</a><a onclick="return confirm('Apakah Anda yakin ?')" href="delete_galeri.php?id=<?php echo $data['id'] ?>" class="btn-xs btn-danger">Delete</a></td>
              </tr>
              <?php $no++;}?>
            </tbody>
          </table>
